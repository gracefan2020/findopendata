...
class SimilarPackageSearchResultPage extends React.Component {
	...
	fetchSearchResults() {
		...
		const dataFormats = this.props.selectedDataFromats.map((f) => f.format);
	...
	componentDidUpdate(prevProps) {
		if (
			...
			this.props.selectedDataFromats !== prevProps.selectedDataFromats
		) {
			this.fetchSearchResults();
		}
	}
	...
	render() {
		return (
			<PackageSearchResults
				...
				selectedDataFromats={this.props.selectedDataFromats}
